...
public final class QueryUtils {
    ...
    public static ArrayList<Earthquake> fetchEarthquakeData(String requestURL){
        ...
        Log.v(LOG_TAG,"QUERYUTILS FETCHING EARTHQUAKE DATA");
        if (requestURL==null){
            Log.v(LOG_TAG,"Nothing in fetchEarthquakeData requestURL");
            return null;
        ...
        Log.v(LOG_TAG,"QUERYUTILS RETURNING EARTHQUAKE DATA");
        return earthquakes;
